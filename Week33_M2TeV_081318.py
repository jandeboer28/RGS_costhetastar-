...
fA1 = rt.TFile("BulkGravToWW_narrow_M-1000_13TeV-madgraph19.root","READ")
fA2 = rt.TFile("BulkGravToWW_narrow_M-1200_13TeV-madgraph109.root","READ")
fA3 = rt.TFile("BulkGravToWW_narrow_M-1200_13TeV-madgraph110.root","READ")
fA4 = rt.TFile("BulkGravToWW_narrow_M-1400_13TeV-madgraph28.root","READ")
fA5 = rt.TFile("BulkGravToWW_narrow_M-1600_13TeV-madgraph119.root","READ")
fA6 = rt.TFile("BulkGravToWW_narrow_M-1800_13TeV-madgraph17.root","READ")
fA7 = rt.TFile("BulkGravToWW_narrow_M-1800_13TeV-madgraph18.root","READ")        
fA8 = rt.TFile("BulkGravToWW_narrow_M-2000_13TeV-madgraph.root","READ")
    ##fB = rt.TFile("BulkGravToWW_narrow_M-2000_13TeV-madgraph163.root", "READ")
    ##fC = rt.TFile("BulkGravToWW_narrow_M-2000_13TeV-madgraph164.root", "READ")
    ##fD = rt.TFile("BulkGravToWW_narrow_M-2000_13TeV-madgraph165.root", "READ")
    ##fE = rt.TFile("BulkGravToWW_narrow_M-2000_13TeV-madgraph166.root", "READ")
    ##fF = rt.TFile("BulkGravToWW_narrow_M-2000_13TeV-madgraph167.root", "READ")
fA9 = rt.TFile("BulkGravToWW_narrow_M-2500_13TeV-madgraph123.root","READ")
fA10 = rt.TFile("BulkGravToWW_narrow_M-2500_13TeV-madgraph124.root","READ")
fA11 = rt.TFile("BulkGravToWW_narrow_M-3000_13TeV-madgraph115.root","READ")
fA12 = rt.TFile("BulkGravToWW_narrow_M-3000_13TeV-madgraph116.root","READ")
fA13 = rt.TFile("BulkGravToWW_narrow_M-3000_13TeV-madgraph117.root","READ")
fA14 = rt.TFile("BulkGravToWW_narrow_M-3000_13TeV-madgraph118.root","READ")
fA15 = rt.TFile("BulkGravToWW_narrow_M-3500_13TeV-madgraph97.root","READ")
fA16 = rt.TFile("BulkGravToWW_narrow_M-3500_13TeV-madgraph98.root","READ")
fA17 = rt.TFile("BulkGravToWW_narrow_M-4000_13TeV-madgraph10.root","READ")
fA18 = rt.TFile("BulkGravToWW_narrow_M-4000_13TeV-madgraph.root","READ")
   #EmptyfA = rt.TFile("BulkGravToWW_narrow_M-4500_13TeV-madgraph0.root","READ")
   #EmptyfA = rt.TFile("BulkGravToWW_narrow_M-600_13TeV-madgraph11.root","READ")
   #EmptyfA = rt.TFile("BulkGravToWW_narrow_M-800_13TeV-madgraph114.root","READ")

F = [fA1, fA2, fA3, fA4, fA5, fA6, fA7, fA8, fA9, fA10, fA11, fA12, fA13, fA14, fA15, fA16, fA17, fA18]#,fB,fC,fD,fE,fF]

#for entry in F :
#    print(entry)
#                   -> gives all root objects.
...
f2A1 = rt.TFile("RSGravToWW_width0p1_M-1200_TuneCUETP8M1_13TeV-madgraph-pythia829.root", "READ")
f2A2 = rt.TFile("RSGravToWW_width0p1_M-1200_TuneCUETP8M1_13TeV-madgraph-pythia830.root", "READ")
    ##f2B = rt.TFile("RSGravToWW_width0p1_M-2000_TuneCUETP8M1_13TeV-madgraph-pythia857.root", "READ")
    ##f2C = rt.TFile("RSGravToWW_width0p1_M-2000_TuneCUETP8M1_13TeV-madgraph-pythia858.root", "READ")
f2A3 = rt.TFile("RSGravToWW_width0p1_M-2000_TuneCUETP8M1_13TeV-madgraph-pythia8.root", "READ")
f2A4 = rt.TFile("RSGravToWW_width0p1_M-3000_TuneCUETP8M1_13TeV-madgraph-pythia86.root", "READ")
f2A5 = rt.TFile("RSGravToWW_width0p1_M-4000_TuneCUETP8M1_13TeV-madgraph-pythia8120.root", "READ")
f2A6 = rt.TFile("RSGravToWW_width0p1_M-4000_TuneCUETP8M1_13TeV-madgraph-pythia8121.root", "READ")
   #LOW f2A = rt.TFile("RSGravToWW_width0p1_M-800_TuneCUETP8M1_13TeV-madgraph-pythia889.root", "READ")
   #EMPTY f2A = rt.TFile("RSGravToWW_width0p1_M-2000_TuneCUETP8M1_13TeV-madgraph-pythia890.root", "READ")




F2 = [f2A1, f2A2, f2A3, f2A4, f2A5, f2A6 ]#,f2B]#,f2C]
...
h_theta_cm1_B = rt.TH1F("B theta CM", "W rest frame emission angle", 50, 0, 1)
h_theta_cm2_B = rt.TH1F("B theta CM", "W rest frame emission angle", 50, 0, 1)
h_dtheta_cm_B = rt.TH1F("B dtheta CM", "#theta_{1}+#theta_{2} in V frame", 100, -1, 1)


h_theta_cm1_RS = rt.TH1F("RS theta CM", "W rest frame emission angle", 50, 0, 1)
h_theta_cm2_RS = rt.TH1F("RS theta CM", "W rest frame emission angle", 50, 0, 1)
...
#        h_theta_cm1_B.Fill(Mcostheta*180/np.pi)
        ...
        if (pf == 1 or pfc) and (bc <  233147):
            ...
            DPy2_B.append(py2)
            DPz2_B.append(pz2)
            DCT_B.append(abs(np.cos(costheta1)))
            DCT2_B.append(abs(np.cos(costheta2)))
    ...
    for event in t2 :
        ...
        # -> making numpy arrays for Keras :
            if (pf == 1 or pfc):
                ...
                h_theta_cm1_RS.Fill(abs(np.cos(costheta1)))
                h_theta_cm2_RS.Fill(abs(np.cos(costheta2)))
                ...
                DPy2.append(py2)
                DPz2.append(pz2)
                DCT.append(abs(np.cos(costheta1)))
                DCT2.append(abs(np.cos(costheta2)))
                DT.append(costheta1)
                B.append(beta)
                Minv_A.append(Minv)
...
# ROC-curve and AUC :
    ...
    TheBulk_hist = ax.hist(DCT_B, bins = 50, range=(0,1))
    TheRS_hist = ax.hist(DCT, bins = 50, range=(0,1)) 
    FPR, TPR = calc_ROC(TheBulk_hist, TheRS_hist)      #
    AUCtheta = metrics.auc(FPR, TPR) 
    print("AUC = {:2f}".format(AUCtheta))
...
df_B = pd.DataFrame({'VE_B':VE_B, 'VPt_B':VPt_B, 'VEta_B':VEta_B, 'VPhi_B':VPhi_B, 'VPx_B':VPx_B, 'VPy_B' :VPy_B,   'VPz_B':VPz_B, 'DE_B':DE_B, 'DPt_B':DPt_B, 'DEta_B':DEta_B, 'DPhi_B':DPhi_B, 'DPx_B':DPx_B, 'DPy_B' :DPy_B,   'DPz_B':DPz_B,'DE2_B':DE2_B, 'DPt2_B':DPt2_B, 'DEta2_B':DEta2_B, 'DPhi2_B':DPhi2_B, 'DPx2_B':DPx2_B, 'DPy2_B' :DPy2_B,   'DPz2_B':DPz2_B, 'DCT_B':DCT_B, 'DCT2_B':DCT2_B, 'DT_B':DT_B, 'B_B':B_B, 'W_B':W_B, 'W2_B':W2_B, 'Tau21_B': Tau21_B, 'SDM_B': SDM_B})

par_detector_1D_B  = ['VE_B', 'VPt_B', 'VEta_B', 'VPhi_B', 'DE_B', 'DPt_B', 'DEta_B', 'DPhi_B']#, 'B_B']
par_cartesian_1D_B = ['DE_B', 'DPx_B', 'DPy_B',  'DPz_B','DE2_B', 'DPx2_B', 'DPy2_B', 'DPz2_B']
par_detector_1D2_B  = ['VE_B', 'VPt_B', 'VEta_B', 'VPhi_B', 'DE2_B', 'DPt2_B', 'DEta2_B', 'DPhi2_B']#, 'B_B']
par_cartesian_1D2_B = ['DE2_B', 'DPx2_B', 'DPy2_B', 'DPz2_B','DE_B', 'DPx_B', 'DPy_B',  'DPz_B']
...
par_cartesian_2D_B = [ 'VE_B', 'VPx_B', 'VPy_B',  'VPz_B', 'DE_B', 'DPx_B', 'DPy_B',  'DPz_B',  'DCT_B','DE2_B', 'DPx2_B', 'DPy2_B',  'DPz2_B','DCT2_B', 'B_B', 'Tau21_B' ] #SDM_B
...
df = pd.DataFrame({'VE':VE, 'VPt':VPt, 'VEta':VEta, 'VPhi':VPhi, 'VPx':VPx, 'VPy' :VPy,   'VPz':VPz, 'DE':DE, 'DPt':DPt, 'DEta': DEta, 'DPhi': DPhi, 'DPx':DPx, 'DPy' :DPy,   'DPz':DPz,'DE2':DE2, 'DPt2':DPt2, 'DEta2':DEta2, 'DPhi2':DPhi2, 'DPx2':DPx2, 'DPy2' :DPy2,   'DPz2':DPz2, 'DCT':DCT, 'DCT2':DCT2, 'DT':DT, 'B':B, 'W':W, 'W2':W2, 'Tau21_A':Tau21_A, 'SDM_A': SDM_A})

par_detector_1D  = ['VE', 'VPt', 'VEta', 'VPhi', 'DE', 'DPt', 'DEta', 'DPhi']#, 'B']
par_cartesian_1D = ['DE','DPx', 'DPy',  'DPz', 'DE2', 'DPx2', 'DPy2', 'DPz2']
par_detector_1D2  = ['VE', 'VPt', 'VEta', 'VPhi', 'DE2', 'DPt2', 'DEta2', 'DPhi2']
par_cartesian_1D2 = ['DE2', 'DPx2', 'DPy2', 'DPz2','DE', 'DPx', 'DPy', 'DPz']

# used for CLS :
par_detector_2D  = ['VE', 'VPt', 'VEta', 'VPhi', 'DE', 'DPt', 'DEta', 'DPhi', 'DE2', 'DPt2', 'DEta2', 'DPhi2', 'B', 'DCT', 'DCT2', 'Tau21_A']
par_cartesian_2D = ['VE', 'VPx', 'VPy',  'VPz',  'DE', 'DPx', 'DPy',  'DPz','DCT',  'DE2', 'DPx2', 'DPy2',  'DPz2', 'DCT2', 'B','Tau21_A'] #SDM_A
...
dfCLScar2D = df[par_cartesian_2D].loc[0:len(dfCLScar2D_B), :]
print(len(dfCLScar2D))
...
if RGS :
    Ne = 40     # set the number of epochs

    model = Sequential([
            Dense(DIM, input_shape=(DIM,), kernel_initializer='normal', activation= 'tanh'),
    ...
    #        Dense(32, kernel_initializer='normal', activation = 'relu'),
    #       Dropout(rate = 0.2),
#            Dense(16, kernel_initializer='normal', activation = 'relu'),       #            Dense(100, kernel_initializer='normal', activation = 'relu'),       #            Dense(100, kernel_initializer='normal', activation = 'relu'),
#            Dense(100, kernel_initializer='normal', activation = 'relu'),
#            Dense(100, kernel_initializer='normal', activation = 'relu'),
#            Dense(100, kernel_initializer='normal', activation = 'relu'),
            #       Dropout(rate = 0.2),
#            Dense(100, kernel_initializer='normal', activation = 'relu'),       #           Dense(128, kernel_initializer='normal', activation = 'relu'),
#            Dense(128, kernel_initializer='normal', activation = 'relu'),
            Dense(1,  kernel_initializer='normal')])    
    
    model.summary()
    model.compile(loss='mean_squared_error', metrics='accuracy', optimizer='adam')                                             # Adam the method used the minimize the loss, lr = learning rate is the step it search on your hyperparameters
...
#                 plotting the prediction in a histogram
    ...
    if BULK :
        h_theta_cm1_pred= rt.TH1F("Bulk theta CM", "ML predicted cos #theta^{*}", 50, 0, 1)
        h_theta_cm1_real= rt.TH1F("Bulk theta CM", "ML predicted cos#theta^{2}", 50, 0, 1)

    if RS :
        h_theta_cm1_pred= rt.TH1F("RS theta CM", "ML predicted cos #theta^{*}", 50, 0, 1)
        h_theta_cm1_real= rt.TH1F("RS theta CM", "ML predicted cos#theta^{2}", 50, 0, 1)
...
if CLS :
    ...
    model = Sequential([
            Dense(DIM, input_shape=(DIM,), activation= 'relu'),
...
#                   training of the model
    ...
    history = model.fit(X_train, Y_train, batch_size = 20, validation_split = 0.1, shuffle = True, epochs = Ne, verbose = 2) #, batch_size = 10
...
# ROC-curve and AUC :
    ...
    print("ROC Curve AUC = {:3f} ".format( AUC))
    ...
    leg.SetLineColor(rt.kWhite)
    leg.SetFillStyle(0)
    leg.AddEntry(gr,"ROC Curve AUC = {:3f} ".format( AUC),"l")
